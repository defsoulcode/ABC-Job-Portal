...
<jsp:include page="../components/uheader.jsp"/>
<!-- 
...
<div id="about" class="container text-center" style="margin-left:80px; margin-top: 150px; margin-bottom:40px;">
  <h3>About</h3>
